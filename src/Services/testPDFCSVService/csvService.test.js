import { generateCSVReport } from "../csvService";
...
describe("generateCSVReport", () => {
  const mockBlob = new Blob(["mocked content"], { type: "text/csv" });
  ...
  it("should generate and download the CSV report correctly", async () => {
    // Call the function
  ...
  it("should handle errors correctly", async () => {
    ...
    const result = await generateCSVReport({
      contaOrigem: "123",
      contaDestino: "456",
      nomeOrigem: "Origem",
      nomeDestino: "Destino",
